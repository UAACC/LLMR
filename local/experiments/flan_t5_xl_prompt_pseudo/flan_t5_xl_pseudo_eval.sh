...
flan_t5_xl_pseudo=/home/dongheng/LLMR/local/experiments/flan_t5_xl_prompt_pseudo
...
do
op=$flan_t5_xl_pseudo/results_${data}_$sp.tgt
...
python metrics.py --lowercase --gen $op --ref $dataset/$sp.$tgt --src $dataset/$sp.$src >> $flan_t5_xl_pseudo/$sp.$data.log
done