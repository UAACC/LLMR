...
t5_prompt_tem=/home/mrli/projects/def-lilimou/mrli/projects/LLMR/experiments/t5_prompt_tem
src=src
tgt=tgt

for sp in valid test
do
op=/home/mrli/projects/def-lilimou/mrli/projects/LLMR/experiments/t5_prompt_tem/results_TEM.tgt
...
echo $dataset >> $t5_prompt_tem/$sp.$data.log 
head -n 1 $template >> $t5_prompt_tem/$sp.$data.log 
python metrics.py --lowercase --gen $op --ref $dataset/$sp.$tgt --src $dataset/$sp.$src >> $t5_prompt_tem/$sp.$data.log
done
